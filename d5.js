...
const nameFunc = strive
const splitNameFunc = nameFunc.split(' ')

const splitNameFunc = ['s', 't', 'r', 'i', 'v', 'e']
const reverseNameFunc = splitNameFunc.reverse()

const reverseNameFunc = ['e', 'v', 'i', 'r', 't', 's']
const result = reverseNameFunc.join(' ')
